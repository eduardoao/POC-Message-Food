...
namespace POC.Modules.Domain.Entities
{
    public class Order : Notifiable, IEntity
    {
        ...
        public List<OrderItem> Itens { get { return (List<OrderItem>)_itens; } set { _itens = value; } } 
        public List<Delivery> Deliveries { get { return (List<Delivery>) _deliveries; } set { _deliveries = value; } }

        public Guid Id { get; set; }

        //Adicionar Item
        public void AddItem(Product product, int quantity, EAreas eAreas)
        {
            ...
            var item = new OrderItem(product, quantity, eAreas);
            _itens.Add(item);
        }
        ...
        //Enviar -> Se 10 itens, fazer 2 deliveries
        public void Ship()
        {
            ...
            deliveries.ForEach(s => s.Send());
            //adicionar entregas aos pedidos
            deliveries.ForEach(o => _deliveries.Add(o));
        }
